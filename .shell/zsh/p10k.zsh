# Generated by Powerlevel10k configuration wizard on 2019-10-29 at 18:30 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='%1F%f'
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=242
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%3F%n%f@%2F%m%f'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=1
  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%1F%B%n%f@%2F%m%f'
